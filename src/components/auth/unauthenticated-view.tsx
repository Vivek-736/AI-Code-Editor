...
export const UnauthenticatedView = () => {
    return (
        <div className="relative font-sans min-h-screen flex justify-center overflow-hidden bg-linear-to-br from-slate-950 via-slate-900 to-slate-950 text-foreground">
                ...
                <div className="w-full max-w-xl space-y-8 rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-xl">
                    <div className="flex flex-col items-center gap-3 text-center">
                        <div className="inline-flex items-center gap-3 rounded-full border border-white/10 bg-black/30 px-4 py-2 shadow-lg">
                            ...
                            <span className="text-base font-mono font-semibold tracking-wide text-white">
                                Orbit
                            </span>
                        </div>
